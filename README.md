...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/findlibs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14649&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/findlibs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `findlibs` can be installed with:

```
conda install findlibs
```

It is possible to list all of the versions of `findlibs` available on your platform with:
